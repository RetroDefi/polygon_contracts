...
contract pQBERT is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   QBERTDividendTracker public dividendTracker;
    ...
    uint256 public  NATIVERewardsFee = 7;
    ...
    constructor() public ERC20("pQBERT", "pQBERT") {

        _marketingWallet = 0x1F40C69eDfF22BFb99441641922778184dD07e69;
...
contract QBERTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("QBERT_Dividend_Tracker", "QBERT_Dividend_Tracker") {
        claimWait = 3600;
